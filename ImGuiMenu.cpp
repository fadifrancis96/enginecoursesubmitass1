...
IGL_INLINE void ImGuiMenu::draw_viewer_menu(igl::opengl::glfw::Viewer *viewer, std::vector<igl::opengl::ViewerCore>& core)
{
    ...
    if (welcomeWindow)
    {
        ...
        ImGui::SetNextWindowPos(ImVec2(180.f * (hidpi_scaling_ / pixel_ratio_), 10), ImGuiCond_FirstUseEver);
    ...
    /*    ImGui::SetNextWindowPos(ImVec2(1, 1), ImGuiCond_FirstUseEver);
        ...
        ImGui::InputText("Please Enter Your Name", name, IM_ARRAYSIZE(name));
    ...
    if (viewer->finishLevel)
    {
        ...
        ImGui::Text("THATS WHAT IM TALKING ABOUT , ARE YOU READY FOR THE NEXT LEVEL ?");
  ...
  //  // for our project
  //  make_checkbox("Assignment 2", viewer->data().assignment2);
  //  make_checkbox("Assignment 3", viewer->data().assignment3);
  //  
