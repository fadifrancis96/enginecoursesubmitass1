  ...
  bool update_matrices)
{
  ...
  if (is_set(data.assignment3))
      data.assignment3bool = true;
  else data.assignment3bool = false;
  if (is_set(data.assignment2))
      data.assignment2bool = true;
  else 
      data.assignment2bool = false;
